                                        ...
                                        <div class="card-body p-4">
                                            ...
                                            <form class="row g-3" action="{{ route('update.room',$editData->id) }}" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <img id="showImage" src="{{ (!empty($editData->image)) ? url($editData->image) : url('upload/no_image.jpg') }}" alt="Admin" class="bg-primary" width="70" height="50"> 
                                                </div>
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <textarea class="form-control" name="short_desc" id="input11" placeholder="Address ..." rows="3">{{$editData->short_desc}}</textarea>
                                                </div>
                                                <div class="col-md-12">
